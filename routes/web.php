...
Route::group(['namespace' => 'Frontend'], function () {
    ...
    Route::post('comment-replay-delete/{id}', 'WebsiteController@deleteCommnetReply')->name('deleteCommentReply')->middleware('auth');
});
...
Route::group(['namespace' => 'Admin', 'prefix' => 'communication', 'as' => 'communication.', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('student-mails', 'CommunicationController@StudentMails')->name('StudentMails');
    ...
    Route::any('SendStudentMail', 'CommunicationController@SendStudentMail')->name('SendStudentMail');
