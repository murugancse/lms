                                        ...
                                        @if($course->class->host=="BBB")
                                            @foreach($course->class->bbbMeetings as $key=>$meeting)
                                                <div class="row justify-content-between text-center p-3 m-2"
                                                    ...
                                                    <div class="{{$allow?'col-sm-3':'col-sm-4'}} "
                                                         style="border-right: 1px solid #E1E2E6;">
                                                        <span>
                                                        {{__('common.Start Date & Time')}}
                                                    </span>

                                                        <h5 class="mb-0">{{date('d M Y \a\t g:i A',$meeting->datetime)}}  </h5>
                                                    </div>
                                                    <div class="{{$allow?'col-sm-3':'col-sm-4'}}"
                                                         style="border-right: 1px solid #E1E2E6;">
                                                         <span>
                                                        {{__('common.End Date & Time')}}
                                                    </span>
                                                        @if($meeting->duration==0)
                                                            <h5 class="mb-0"> N/A </h5>
                                                        @else
                                                            <h5 class="mb-0">{{date('d M Y \a\t g:i A',$meeting->datetime+($meeting->duration*60))}}  </h5>
                                                        @endif
                                                    </div>
                                                    <div class="{{$allow?'col-sm-3':'col-sm-4'}}"
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            @if(@$meeting->isRunning())
                                                                <a target="_blank"
                                                                   ...
                                                                   class="theme_btn small_btn2 d-block text-center height_50 mt_10  p-3 ">
                                                                    {{__('common.Watch Now')}}
                                                                </a>
                                            ...
                                            @foreach($course->class->zoomMeetings as $key=>$meeting)
                                                <div class="row justify-content-between text-center p-3 m-2"
                                                    ...
                                                    <div class="{{$allow?'col-sm-3':'col-sm-4'}} "
                                                        ...
                                                        <h5 class="mb-0">{{date('d M Y \a\t g:i A',strtotime($meeting->start_time))}}  </h5>
                                                    </div>
                                                    <div class="{{$allow?'col-sm-3':'col-sm-4'}}"
                                                         style="border-right: 1px solid #E1E2E6;">
                                                         <span>
                                                        ...
                                                        <h5 class="mb-0">{{date('d M Y \a\t g:i A',strtotime($meeting->end_time))}}  </h5>
                                                    </div>
                                                    <div class="{{$allow?'col-sm-3':'col-sm-4'}}"
                                                         style="{{$allow?'border-right: 1px solid #E1E2E6;':''}}">
                                                        <span>
                                                            ...
                                                            <div class="comment_box_text link">
                                                                ...
                                                                @if(commentCanDelete($comment->id,$comment->instructor_id))
                                                                    <a class="position_right deleteBtn" href="#"
                                                                       data-toggle="modal"
                                                                       onclick="deleteCommnet('{{route('deleteComment',$comment->id)}}')"
                                                                    ...
                                                                    <div class="comment_box_text link">
                                                                        ...
                                                                        @if(ReplyCanDelete($replay->user_id,$course->user_id))
                                                                            <a class="position_right" href="#"
                                                                               data-toggle="modal"
                                                                               onclick="deleteCommnet('{{route('deleteCommentReply',$replay->id)}}')"
                                                                               data-target="#deleteComment">
                                                                                <i class="fas fa-trash  fa-xs"></i>
                                                                            </a>
                                                                        @endif
