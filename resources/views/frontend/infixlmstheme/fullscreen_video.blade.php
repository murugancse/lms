                            ...
                            @if($lesson->chapter_id==$chapter->id)
                                ...
                                @foreach ($lesson->quiz as $quiz)
                                                    <span class="quizLink"
                                                          ...
                                                          onclick='goQuizTest("{{route('quizStart',[$course->id,$lesson->quiz_id,$lesson->lessonQuiz->title])}}")'
                                                          data-url="{{route('quizStart',[$course->id,$lesson->quiz_id,$lesson->lessonQuiz->title])}}">
