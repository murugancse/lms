                            ...
                            <form action="{{route('update_user')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-25">
                                        ...
                                        <select class="primary_select  cityList" name="city" id="city">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-md-12 mb-25" style="    margin-top: 70px;">
                                            ...
                                            <label class="primary_input_label"
                                                ...
                                                <small>({{$user->subscription_api_status==1?'Connected':'Not Connected'}})</small> </label>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, item) {
                        $('select.cityList ').append($('<option>', {
                            value: item.id,
                            text: item.name
                        }));
                        $("div.cityList ul").append("<li data-value='" + item.id + "' class='option'>" + item.name + "</li>");
                    });
