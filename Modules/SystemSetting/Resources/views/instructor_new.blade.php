            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 p-0">
                    <div class="">
                        ...
                        <div class="white-box  ">
                            <form id="instructorForm" action="{{route('instructor.store')}}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field" name="name" required="" placeholder="-" id="addName"
                                                       type="text"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                ...
                                                <div class="input-group mb-2 mr-sm-2">
                                                    ...
                                                    <input type="password" required class="form-control primary_input_field"
