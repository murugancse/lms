        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                ...
                <div class="bc-pages">
                    ...
                    <a href="#">Grade</a>
                    <a class="active" href="#">Grade List</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if(isset($grade))
                                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => array('grade-update',@$grade->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                            @else
                                
                                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'grade.store',
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        @if (permissionCheck('question-group.edit'))
                                                            <a class="dropdown-item edit_brand"
                                                               href="{{route('grade-edit',$group->id)}}">{{__('common.Edit')}}</a>
                                                        @endif
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mt-40 d-flex justify-content-between">
                                                            ...
                                                            {{ Form::open(['route' => array('grade-delete',$group->id), 'method' => 'DELETE', 'enctype' => 'multipart/form-data']) }}
