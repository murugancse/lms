                                                                    ...
                                                                    <div class="input-effect">
                                                                        <div class="input-effect">
                                                                            <div class="text-left float-left">
                                                                                ...
                                                                                <label
                                                                                    for="midtrans_env_local{{$payment_method->id}}">{{__('common.Sandbox')}}</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <div class="input-effect">
                                                                            <div class="text-left float-left">
                                                                                <input type="radio"
                                                                                       ...
                                                                                       class="common-radio relationButton read-only-input">
                                                                                <label
                                                                                    for="midtrans_env_live{{$payment_method->id}}">{{__('common.Live')}}</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <div class="input-effect">
                                                                            <div class="text-left float-left">
                                                                                <input type="radio"
                                                                                       ...
                                                                                       class="common-radio relationButton read-only-input">
                                                                                <label
                                                                                    for="midtrans_sanitize_no{{$payment_method->id}}">{{__('common.Sanitize No')}}</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <div class="input-effect">
                                                                            <div class="text-left float-left">
                                                                                <input type="radio"
                                                                                       ...
                                                                                       class="common-radio relationButton read-only-input">
                                                                                <label
                                                                                    for="midtrans_sanitize_yes{{$payment_method->id}}">{{__('common.Sanitize Yes')}}</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <div class="input-effect">
                                                                            <div class="text-left float-left">
                                                                                <input type="radio"
                                                                                       ...
                                                                                       class="common-radio relationButton read-only-input">
                                                                                <label
                                                                                    for="midtrans_3ds_no{{$payment_method->id}}">{{__('common.3DS No')}}</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <div class="input-effect">
                                                                            <div class="text-left float-left">
                                                                                <input type="radio"
                                                                                       ...
                                                                                       class="common-radio relationButton read-only-input">
                                                                                <label
                                                                                    for="midtrans_3ds_yes{{$payment_method->id}}">{{__('common.3DS Yes')}}</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
