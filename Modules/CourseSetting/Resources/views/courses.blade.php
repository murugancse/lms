                                                                ...
                                                                <div class="col-xl-8 ">
                                                                    <div class="input-effect videoUrl"
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            autocomplete="off"
                                                                            value="{{isset($course) &&$course->host=="Youtube"? $course->trailer_link:''}}" {{$errors->has('trailer_link') ? 'autofocus' : ''}}>
                                                                            ...
                                                                            <div class="primary_input">
                                                                                ...
                                                                                <div class="primary_file_uploader">
                                                                                    <input
                                                                                        ...
                                                                                        type="text"
                                                                                        value="{{showPicName(@$course->trailer_link)}}"
                                                                                        placeholder="{{__('courses.Browse Video file')}}"
                                                                                        readonly="">
                                                                                    <button class="" type="button">
                                                                                        <label
                                                                                            class="primary-btn small fix-gr-bg"
                                                                                            for="document_file_{{$course->id}}">{{__('common.Browse') }}</label>
                                                                                        <input type="file"
                                                                                               class="d-none fileUpload"
                                                                                               name="file"
                                                                                               id="document_file_{{$course->id}}">
                                                                                    </button>
                                                                    ...
                                                                    <select class="primary_select"
                                                                        ...
                                                                        @foreach($sub_lists as $list)
                                                                            <option value="{{$list['id']}}"
                                                                                    @if (@$course->subscription_list==$list['id']) selected @endif>
                                                                                {{$list['name']}}
                                                                            </option>
                                                                        @endforeach
