                                ...
                                <div class="white-box">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            ...
                                            <select {{ $errors->has('class_type') ? ' autofocus' : '' }}
                                                ...
                                                <option {{ isset($class) && $class->class_type==0 ? 'selected' : '' }} value="0"> 1 and 1 class  </option>
                                                <option {{ isset($class) && $class->class_type==1 ? 'selected' : '' }} value="1"> Group Class </option>
                                    ...
                                    <div class="row mt-20">
                                        ...
                                        <div class="col-lg-12 ">
                                            ...
                                            <div style="display: none;" class="input-effect d-hide">
                                                <input
