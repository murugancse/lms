                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            ...
                                            <select {{ $errors->has('class_type') ? ' autofocus' : '' }}
                                                ...
                                                <option @if(isset($class) && $class->class_type==0 ) selected @endif value="0"> 1 and 1 class  </option>
                                                <option @if(isset($class) && $class->class_type==1 ) selected @endif value="1"> Group Class </option>
