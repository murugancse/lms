...
class InstamojoController extends Controller
{
    ...
    {
        $this->url = env('Instamojo_URL');
        $this->key = env('Instamojo_API_AUTH');
        $this->token = env('Instamojo_API_AUTH_TOKEN');
    }
    ...
    public function depositProcess(Request $request)
    {
        ...
        $amount = convertCurrency(getSetting()->currency->code ?? 'BDT', 'INR', $request->deposit_amount);
    ...
    public function depositSuccess(Request $request)
    {
        ...
        if ($data->success == true) {
            if ($data->payment->status == 'Credit') {
                ...
                $amount = round(convertCurrency($data->payment->currency, strtoupper(getSetting()->currency->code ?? 'BDT'), $data->payment->amount));
    ...
    public function paymentProcess($amount)
    {
        ...
        $amount = convertCurrency(getSetting()->currency->code ?? 'BDT', 'INR', $amount);
