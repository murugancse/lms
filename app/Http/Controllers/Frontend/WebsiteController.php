...
class WebsiteController extends Controller
{
    ...
    public function common()
    {
        ...
        $data['newsletterSetting'] = NewsletterSetting::first();
        return $data;
    }
...
//speedup
    ...
    {
        try {
            $cities = DB::table('spn_cities')->select('id', 'name')->where('country_id', '=', $request->id)->get();
    ...
    public function fullScreenView($course_id, $lesson_id)
    {
        ...
        return view(theme('fullscreen_video'), $data, compact('chapters', 'reviewer_user_ids', 'percentage', 'isEnrolled', 'total', 'certificate', 'course', 'lesson', 'lessons'));
...
//
    ...
    public
    function deleteCommnetReply($id)
    {
        try {
